...
//timoni:generate timoni vendor crd -f https://raw.githubusercontent.com/crossplane/crossplane/v1.16.0/cluster/crds/pkg.crossplane.io_deploymentruntimeconfigs.yaml

package v1beta1

import "strings"

// The DeploymentRuntimeConfig provides settings for the
...
// DeploymentRuntimeConfigs](https://docs.crossplane.io/latest/concepts/providers/#runtime-configuration).
#DeploymentRuntimeConfig: {
	...
	// DeploymentRuntimeConfigSpec specifies the configuration for a
	// packaged controller.
	// Values provided will override package manager defaults. Labels
	// and
	// annotations are passed to both the controller Deployment and
	// ServiceAccount.
...
#DeploymentRuntimeConfigSpec: {
	...
	deploymentTemplate?: {
		// Metadata contains the configurable metadata fields for the
		// Deployment.
		metadata?: {
			...
			// objects.
			// More info:
			// http:https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/
			annotations?: {
				[string]: string
			}
			...
			// categorize
			// (scope and select) objects. Labels will be merged with internal
			// labels
			// used by crossplane, and labels with a crossplane.io key might
			// be
			// overwritten.
			// More info:
		...
		// Spec contains the configurable spec fields for the Deployment
		// object.
		spec?: {
			...
			// available.
			// Defaults to 0 (pod will be considered available as soon as it
			// is ready)
			minReadySeconds?: int
